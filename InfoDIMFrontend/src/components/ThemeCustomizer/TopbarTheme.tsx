...
const TopbarTheme = ({
  ...
  return (
    <>
      <h6 className="fw-medium font-14 mt-4 mb-2 pb-1">Barre de navigation</h6>
      ...
      <Form.Check className="form-check form-switch mb-1">
        ...
        />
        <Form.Check.Label htmlFor="lighttopbar-check">Clair</Form.Check.Label>
      </Form.Check>
      ...
      <Form.Check className="form-check form-switch mb-1">
        ...
        />
        <Form.Check.Label htmlFor="darktopbar-check">Sombre</Form.Check.Label>
      </Form.Check>
      ...
      <Form.Check className="form-check form-switch mb-1">
        ...
        />
        <Form.Check.Label htmlFor="brandtopbar-check">Thème</Form.Check.Label>
      </Form.Check>
    </>
  );
};
