...
const LayoutWidth = ({
  ...
  return (
    <>
      <h6 className="fw-medium font-14 mt-4 mb-2 pb-1">Largeur</h6>
      ...
      <Form.Check className="form-check form-switch mb-1">
        ...
        />
        <Form.Check.Label htmlFor="fluid-check">Fluide</Form.Check.Label>
      </Form.Check>
      ...
      <Form.Check className="form-check form-switch mb-1">
        ...
        />
        <Form.Check.Label htmlFor="boxed-check">Encadrée</Form.Check.Label>
      </Form.Check>
    </>
  );
};
