...
const TabsAccordions = () => {
  const tabContents: TabContentType[] = [
    ...
    },
    {
      ...
      text: "Paramètres - Food truck quinoa dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.",
    },
  ];
  ...
  const accordianContent2: TabContentType[] = [
    ...
    {
      id: 4,
      title: "Will you regularly give updates of InfoDIM ?",
      text: "Yes, We will update the InfoDIM regularly. All the future updates would be available without any cost",
    },
  ];
